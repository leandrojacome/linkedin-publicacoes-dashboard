# docker-sandbox-kit-spec-ai-agents-2026-09-24

- **Estado:** prepared_target_reached_browser_policy_blocked
- **Produto:** Docker Sandbox Kit Spec
- **Evento:** Docker and CNCF announce an open OCI-based specification for portable AI-agent permissions
- **Versão:** —
- **Fonte principal:** https://www.docker.com/blog/docker-sandbox-kit-spec-cncf/
- **Data do evento:** 2026-09-24
- **Alvo reservado:** 2026-09-24T20:00:00-03:00
- **Link da publicação:** —
- **Envio tentado:** False
...
What can an AI agent actually access?

Docker and CNCF have announced an open Sandbox Kit Spec that packages an agent, its tools, and requested access to networks, credentials, and volumes as an OCI image.

The practical idea: make agent permissions portable and reviewable across environments. This is a proposed open spec, not a finalized standard.
